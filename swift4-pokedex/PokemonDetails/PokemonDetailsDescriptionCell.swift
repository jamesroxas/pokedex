...
public class PokemonDetailsDescriptionCell: UICollectionViewCell {
    ...
    let pokemonEvolutionsTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "     Evolution(s):"
    ...
    let pokemonHeightTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Height:"
        label.font = UIFont.systemFont(ofSize: 14.0)
        label.textColor = UIColor.black
    ...
    let pokemonWeightTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Weight:"
        label.font = UIFont.systemFont(ofSize: 14.0)
        label.textColor = UIColor.black
    ...
    let pokemonIDTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "ID:"
        label.font = UIFont.systemFont(ofSize: 14.0)
        label.textColor = UIColor.black
    ...
    let pokemonTypeTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Type:"
        label.font = UIFont.systemFont(ofSize: 14.0)
        label.textColor = UIColor.black
    ...
    fileprivate lazy var pokemonBodyStackView: UIStackView = { [unowned self] in
    ...
    fileprivate lazy var pokemonIdentifierStackView: UIStackView = { [unowned self] in
        let stackView = UIStackView(arrangedSubviews: [
            self.pokemonIDLabel,
    ...
    fileprivate lazy var pokemonStackView: UIStackView = { [unowned self] in
        let stackView = UIStackView(arrangedSubviews: [
    ...
    let pokemonEvolutionImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.contentMode = UIViewContentMode.scaleAspectFit
        imageView.clipsToBounds = true
        return imageView
    ...
    fileprivate lazy var pokemonEvolutionStackView: UIStackView = { [unowned self] in
